 ...
 * `load-balancer.hetzner.cloud/external-dns-hostname-ipv4-only` - если установить  эту аннотацию не пустой, то в аннотации `external-dns.alpha.kubernetes.io/target` будут только ipv4 адреса
