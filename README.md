...
* `load-balancer.hetzner.cloud/external-dns-hostname-ipv4-only` - If this annotation is set to a non-empty value, then the annotation `external-dns.alpha.kubernetes.io/target` will contain only
